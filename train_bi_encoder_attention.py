...
parser.add_argument("--lambda_", default=0.5, type=float, help="lambda_rationale")
...
parser.add_argument("--seed_val", default=4, type=int, help="Seed value")
...
tokenizer_RP = tokenizer.batch_encode_plus(df.comment_text, add_special_tokens=True,max_length=args.max_len, pad_to_max_length=True, return_attention_masks=True)
...
if args.do_validation:
	val_tokenizer_RP = tokenizer.batch_encode_plus(df_val.comment_text, add_special_tokens=True,max_length=args.max_len, pad_to_max_length=True, return_attention_masks=True)
...
if args.do_test:
	test_tokenizer_RP = tokenizer.batch_encode_plus(df_test.comment_text, add_special_tokens=True,max_length=args.max_len, pad_to_max_length=True, return_attention_masks=True)
